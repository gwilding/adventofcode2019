...
def main():
    ...
    opcode_load = list(np.genfromtxt('/home/georg/georg/scripts/adventofcode2019/input_day5.txt',delimiter=',',dtype=int))
...
def link_rec(array,index,mode=False):
    """
    mode False: position mode
    mode True:  immediate mode
    """
    if mode:
        return array[index]
    else:
